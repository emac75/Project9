...
import 'package:project_9/screens/homepage.dart'; // Certifique-se de importar a página inicial

class BioLoginCreatePage extends StatefulWidget {
  final String email;

  const BioLoginCreatePage({required this.email});

  @override
  _BioLoginCreatePageState createState() => _BioLoginCreatePageState();
}

class _BioLoginCreatePageState extends State<BioLoginCreatePage> {
  ...
  Future<void> registerUser(String email, String videoFile, String frase) async {
    String url = '$API_ADDRESS/validate_user';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Validação Biométrica', style: TextStyle(color: Colors.black)),
